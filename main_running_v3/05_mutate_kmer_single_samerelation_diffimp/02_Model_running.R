...
input_path <- "./result_v3/05_mutate_kmer_single_samerelation_diffimp_result/02_特征值计算/v_3/"
output_base_path <- "./result_v3/05_mutate_kmer_single_samerelation_diffimp_result/03_机器学习计算结果/v_3/"
