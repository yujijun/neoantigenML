...
input_path <- "./result_v3/06_mutate_kmer_single_combind_perfect_result/"
output_base_path <- "./result_v3/06_mutate_kmer_single_combind_perfect_result/"
