...
input_path <- "./result_v3/02_mutate_wholepeptide_single_samerelation_diffimp_result/"
output_base_path <- "./result_v3/02_mutate_wholepeptide_single_samerelation_diffimp_result/"
